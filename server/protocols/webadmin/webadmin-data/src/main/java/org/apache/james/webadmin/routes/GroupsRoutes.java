...
public class GroupsRoutes implements Routes {
    ...
    public void define(Service service) {
        service.get(GROUP_MEMBER_ASSOCIATIONS, this::checkAssociations);
    ...
    public String checkAssociations(Request request, Response response) throws RecipientRewriteTableException, AddressException, JsonProcessingException {
        String jsonString = request.body();
